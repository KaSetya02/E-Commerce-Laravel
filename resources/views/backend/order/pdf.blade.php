...
<style type="text/css">
  ...
  <div class="invoice-header">
    <div class="float-left site-logo">
      <img src="backend/img/logo3.png" width="300px" alt="">
    </div>
    <div class="float-right site-address">
      <h4>{{env('APP_NAME')}}</h4>
      <p>{{env('APP_ADDRESS')}}</p>
      <p>Phone: <a href="tel:{{env('APP_PHONE')}}">082180740502</a></p>
      <p>Email: <a href="mailto:{{env('APP_EMAIL')}}">himawari23shop@gmail.com</a></p>
    </div>
  ...
  <div class="invoice-description">
    ...
    <div class="invoice-right-top float-right" class="text-right">
      <h3>Invoice <img width="60" src="data:image/png;base64,{{DNS2D::getBarcodePNG($order['order_number'], 'QRCODE')}}" alt="barcode"/></h3>

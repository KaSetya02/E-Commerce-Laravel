...
@section('title','HIMAWARI-SHOP || About Us')
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							@endphp
							<h3>Welcome To <span>Himawari-Shop</span></h3>
							<p style="text-align: justify;">@foreach($settings as $data) {{$data->description}} @endforeach</p>
							<div class="button">
